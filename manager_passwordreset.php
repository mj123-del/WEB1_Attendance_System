...
<head>
  ...
  <style>
    ...
    .form-container {
      ...
      box-shadow: 0px 4px 6px rgba(0, 0, 0, 0.1); /* Subtle shadow for form container */
    }

    .form-container input {
      border-radius: 5px; /* Rounded corners for input fields */
      height: 60px; /* Increase input field height */
      width: 100%; /* Make the input fields stretch across the form */
    }
    ...
    /* Adjust form width */
    .form-wrapper {
      max-width: 800px; /* Make the form wider for a rectangular layout */
        ...
        <div class="form-container">
          <form action="process_password_reset.php" method="POST">
            <div class="mb-4">
              ...
              <input type="password" id="new-password" name="new_password" class="form-control" placeholder="Enter you current password" required>
            </div>
            <div class="mb-4">
